    ...
    useEffect(() => {
        const fetchAssignments = async () => {
            try {
                ...
                setErrorMessage(e.response?.data?.message || "Failed to load assignments.");
            } finally {
                setLoading(false);
            }
        };
        ...
        <Box bg="gray.900" minH="100vh" p={8}>
            <HStack justify="space-between" align="flex-start" mb={8}>
                <Box>
                    ...
                    <Text color="gray.400">
                        {user?.role === 'student' 
                            ? "View and submit your pending tasks." 
                    ...
                    {assignments.map((a) => (
                        ...
                        >
                            ...
                            <HStack 
                                ...
                                borderColor="gray.700"
                            >
                                <Text color="gray.500" fontSize="s" fontWeight="bold">
                                ...
                                {user?.role === "student" ? (
                                    ...
                                    <HStack spacing={2}>
                                        <Button size="sm" variant="ghost" colorScheme="blue" onClick={() => navigate(`/manage-assignments/${a._id}`)}>Edit</Button>
                                    </HStack>
                                )}
                            </HStack>
                        </Box>
